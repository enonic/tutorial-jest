...
[source, terminal]
----
npm test src/jest/server/fibonacci.test.ts 
----
...
In order to write more advanced tests, we must introduce a new concept. Let's have a look at link:globals[mocking].
